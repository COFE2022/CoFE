...
#     def __init__(
#             self,
#             datasets: Union[OrderedDict, Dict],
#             weightes: Union[OrderedDict, Dict],
#             sampling_ratios: Union[OrderedDict, Dict],
#             seed=2,
#             epoch=1,
#             split='',
#             shuffle=True
...
#         ds_idx, ds_sample_idx = self._get_dataset_and_index(item)
