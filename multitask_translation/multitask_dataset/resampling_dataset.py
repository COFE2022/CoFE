...
from multitask_translation.multitask_dataset.base_wrapper_dataset2 import BaseWrapperDataset2

logger = logging.getLogger(__name__)


class ResamplingDataset2(BaseWrapperDataset2):
    ...
    def collater(self, samples,**kwargs):
        return super(ResamplingDataset2, self).collater(samples,**kwargs)
