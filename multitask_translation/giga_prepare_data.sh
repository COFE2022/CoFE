...
python data/extract_raw_xsum.py  --dataset_name gigaword --neg_csv $NEG_CSV --pos_out_dir $DATA/pos_raw --neg_out_dir $DATA/neg_raw --keep_neg 0.6 --text_column document --summary_column summary
