...
NEG_CSV=/home/tw2112/codes/s2s/src/xsum_data/xsum_negative2.csv

python data/extract_raw_xsum.py  --dataset_name xsum --neg_csv $NEG_CSV --pos_out_dir $DATA/pos_raw --neg_out_dir $DATA/neg_raw --keep_neg 1 --text_column document --summary_column summary
